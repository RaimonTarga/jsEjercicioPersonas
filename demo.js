...
const pictureField = document.getElementById('pictureField');
const ageField = document.getElementById('ageField');
const eyeField = document.getElementById('eyeField');
...
const registeredField = document.getElementById('registeredField');
...
function fillList(filter){
  ...
  listElements = Array.prototype.slice.call(document.querySelectorAll(".list-item"));
}
...
function selectElement(e){
  let elementName = e.innerHTML;
  let element = personas[elementName];
...
function fillPersonData(person){
  pictureField.src = person.picture;
  idField.innerHTML = "ID: " + person._id;
  indexField.innerHTML = "Index: " +  person.index;
  isActiveField.innerHTML = "Active status: " +  person.isActive;
  balanceField.innerHTML = "Balance: " + person.balance;
  ageField.innerHTML = "Age: " + person.age;
  eyeField.innerHTML = "Eye color: " + person.eyeColor;
  nameField.innerHTML = "Name: " + person.name;
  genderField.innerHTML = "Gender: " + person.gender;
  companyField.innerHTML = "Company: " + person.company;
  emailField.innerHTML = "Email: " + person.email;
  phoneField.innerHTML = "Phone: " + person.phone;
  addressField.innerHTML = "Address: " + person.address;
  aboutField.innerHTML = "About: " + person.about;
  registeredField.innerHTML = "Registration date: " + person.registered;
  latitudeField.innerHTML = "Latitude: " + person.latitude;
  longitudeField.innerHTML = "Longitude: " + person.longitude;
  greetingField.innerHTML = "Greeting: " + person.greeting;
  favoriteFruit.innerHTML = "Favorite fruit: " + person.favoriteFruit;
}
